		...
		<div class="row">
			...
			<div class="col-md-4 col-lg-4 col-xl-3">
				<div class="footer-links mb-40">
					...
					<!-- Footer Links -->
					<ul class="clearfix">
						<li><a href="javascript:void(0)">Business English</a></li>
						<li><a href="javascript:void(0)">Software Development</a></li>
						<li><a href="javascript:void(0)">Finance & Accounting</a></li>
						<li><a href="javascript:void(0)">Health and Fitness</a></li>
						<li><a href="javascript:void(0)">Office Productivity</a></li>
					</ul>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 text-right">
					<ul class="foo-socials text-center clearfix">
						<li><a href="javascript:void(0)" class="ico-facebook"><i class="fab fa-facebook-f"></i></a></li>
						<li><a href="javascript:void(0)" class="ico-twitter"><i class="fab fa-twitter"></i></a></li>
						<li><a href="javascript:void(0)" class="ico-google-plus"><i class="fab fa-google-plus-g"></i></a></li>
						<li><a href="javascript:void(0)" class="ico-tumblr"><i class="fab fa-tumblr"></i></a></li>
					</ul>
				</div>
			</div>
		</div>
