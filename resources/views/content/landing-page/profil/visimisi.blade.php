        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9">
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="h3-sm mt-4"><b>VISI & MISI</b></h3>
            ...
            <div class="row">
                <div class="col-md-8 mt-4">
                    ...
                    <img class="img" src="{{ asset('uploads/identitas/' . $identity->foto_vm) }}" alt="contacts-icon"
                        style="margin-bottom: 30px; width: 100%; border-radius: 15px">
                        ...
                        <div class="col-lg-12">
                            <div class="contact-box">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 mtb-auto text-left">
                                        <span class="fw4">Panduan Pembuatan Soal Ujian Tahun 2036/2027 Link Download
                                            File<br>
