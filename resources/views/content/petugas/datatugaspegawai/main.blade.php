                    ...
                    <div class="card-body">
                        <div class="position-relative">
                            <div class="position-absolute top-0 start-0">
                                <a href="{{ route('tambahTugas') }}" type="button" class="btn btn-ctk"
                                    style="background-color: #5C9DED">
                                    <i class='bx bxs-plus-circle'></i> Tambah Tugas Pegawai</a>
                            </div>
                                ...
                                <table class="table">
                                    <thead class="bg-tbl">
                                        <tr>
                                            ...
                                            <th class="text-center col-lg-3" scope="col">Kode Jabatan</th>
                                            <th class="text-center col-lg-6" scope="col">Nama Jabatan</th>
                                            <th class="text-center" scope="col" colspan="2">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($datatugaspegawai as $p)
                                            <tr>
                                                <td class="text-center">{{ $loop->iteration }}</td>
                                                <td class="text-center">{{ $p->kode_jabatan }}</td>
                                                <td class="text-center">{{ $p->nama_jabatan }}</td>
                                                <td class="text-center">
                                                    <a href="{{ route('editTugas') }}" type="button" class="btn btn-ctk"
