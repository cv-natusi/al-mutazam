    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="card" style="background: #ffffff; padding-bottom: 20px">
                <div class="row">
                    <div class="row">
                        <h6 class="h6-titlecard"><b>Tambah Data primer</b></h6>
                    </div>
                    ...
                    <form class="row g-3" style="margin-left: 10px; margin-top: -10px" method="post"
                        action="{{ route('savedataprimerPetugas') }}">
                        @csrf
                        <div class="col-md-6">
                            <label for="inputCity" class="form-label">Nama Data Primer *</label>
                            <input type="text" id="namadataprimer_guru" name="namadataprimer_guru" class="form-control">
                        </div>
                        <div class="col-md-2">
