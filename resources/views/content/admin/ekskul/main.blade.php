	...
	<div class="page-content">
		...
		<div class="card main-layer">
			...
			<div class="card-body">
				<div class="row mb-3">
					<div class="col-md-3">
						<button type="button" class="btn btn-primary" onclick="editExkul()"> Tambah Ekstrakurikuler</button>
					</div>
...
<script type="text/javascript">
	...
	function loadTable(){
		var table = $('#datatabel').DataTable({
         dom: 'lftip',
			...
			ajax: "{{route('sekolah.ekskul.main')}}",
			columns: [
	...
	function editExkul(id=''){
        $('.main-layer').hide();
        $.post("{{route('sekolah.ekskul.formAddEkskul')}}", {id:id})
        .done(function(data){
